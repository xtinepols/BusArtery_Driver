...
public class PassengerLocationDistance {
    ...
    public PassengerLocationDistance(MapsActivity mapsActivity, LatLng driver, LatLng latLngPass) {
...
//        mMapsActivity.locationDistance(mDistance);
    }
}
